...
import static com.isep.hpah.core.Gamelogic.scanner;
...
public class Wizard {
    public static void main(String[] args) {
        ...
        s.nextLine();
        System.out.println("Veillez entrer votre nom de joueur ：");
        String name = input.next();
        System.out.println("Bonjour," + name);
        System.out.print("\n");
        System.out.println("Il y a quatre maisons,Chaque maison a sa spécificité :\n" +
        ...
        choice();
        System.out.println("我们准备了一个药水作为开学礼物，你可以从以下选项当中选择一个");
